    ...
    <div className={styles.city}>
      ...
      {city && (
        <div className={styles.detail}>
          <button className={styles.button} onClick={onBack}>{button}</button>
          ...
          <div className={styles.temps}>
            ...
            <img className={styles.clima} src={"http://openweathermap.org/img/wn/"+city.img+"@2x.png"} width="80" height="80" alt="" />
